...
I launched ```android-studio-ide-181.5056338-windows.exe``` to start the installation process. The installer responded by presenting the <b>Android Studio Setup</b> dialog box shown in Figure 1.<br>
<br>
